...
<html>
	<head>
		<meta charset = "utf-8">
		<title>Input Data Lalu Lintas</title>
			...
			<div>
				...
				<div>
					<div id='cssmenu' style = "padding-left:230px; width:750px">
						<ul>
						   <li class='last'><a href='lalu_lintas.php'><span>Data</span></a></li>
						   <li class='last'><a href='input_data_lalu_lintas.php'><span>Input Data</span></a></li>
						</ul>
					</div>
				</div>
				
				<div style = "position:absolute; margin-left:50px; margin-top:10px">
					<form method = "post" autocomplete = "on" action = "insert_data_lalu_lintas.php">
						<p style = "font-size:22pt;">Silahkan input data informasi lalu lintas</p>
						<table class = "fontInput">
							<tr class = "padding">
								<td>Kotamadya <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<select name = "jakarta" required>
										<option style = "height:20px;" value = "Pilih">Pilih</option>
										<option style = "height:20px;" value = "Jakarta Barat">Jakarta Barat</option>
										<option style = "height:20px;" value = "Jakarta Utara">Jakarta Utara</option>
										<option style = "height:20px;" value = "Jakarta Pusat">Jakarta Pusat</option>
										<option style = "height:20px;" value = "Jakarta Selatan">Jakarta Selatan</option>
										<option style = "height:20px;" value = "Jakarta Timur">Jakarta Timur</option>
									</select>
								</td>
							<tr class = "padding">
							...
							<tr>
								<td>Lalu Lintas <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<input type = "radio" name = "lalulintas" value = "Lancar" required > Lancar
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "lalulintas" value = "Tersendat" required > Tersendat
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "lalulintas" value = "Macet" required > Macet
								</td>
							</tr>
							<tr class = "padding">
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "lalulintas" value = "Tidak Bisa di Lalui" required > Tidak Bisa di Lalui
								</td>
							</tr>
							
							<tr>
								<td>Kondisi Jalan <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<input type = "radio" name = "jalan" value = "Normal" required > Normal
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "jalan" value = "Berlubang" required > Berlubang
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "jalan" value = "Rusak" required > Rusak
								</td>
							</tr>
							<tr class = "padding">
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "jalan" value = "Tergenang Air" required > Tergenang Air
								</td>
							</tr>
