			...
			<div>
				...
				<div style = "position:absolute; margin-left:50px; margin-top:10px">
					<form method = "post" autocomplete = "on" action = "insert_input_data.php">
						<p style = "font-size:22pt;">Silahkan input data wilayah di <input type = "radio" checked = "checked" name = "jakarta" value = "Jakarta Pusat" selected required> Jakarta Pusat</p>
