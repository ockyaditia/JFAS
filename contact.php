	...
	<body>
		...
		<div class = "divKontenKontak">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:150px;; margin-top:50px;">
					<h1>Admin Ocky Aditia Saputra</h1>
					<tr>
						<td align="right"><a href="ocky.html">Kontak Admin Ocky</a></td>
					</tr>
				</div>

				<div style = "position:absolute; margin-top:150px; margin-left:150px;">
					<h1>Admin Prabowo Nugroho Budisejati</h1>
					<tr>
						<td align="right"><a href="prabowo.html">Kontak Admin Prabowo</a></td>
					</tr>
				</div>

				<div style = "position:absolute; margin-top:250px; margin-left:150px;">
					<h1>Admin Taufik Hidayat Rahajo</h1>
					<tr>
						<td align="right"><a href="taufik.html">Kontak Admin Taufik</a></td>
					</tr>
				</div>
			...
			<div class = "backtoTopKontak">
				<div>
					<hr /><a href="#top">&uarr; Kembali ke atas</a>
				</div>
			</div>
			
			<table class = "autoMargin copyrightKontak">
				<tfoot>
					<tr>
						<td class = "align footerSize">Copyright &copy; 2014. <span style = "color:blue">JFAS Information System</span>. All right reserved.</td>
					</tr>
