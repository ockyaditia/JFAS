	...
	<body>
		...
		<div class = "divKontenFitur">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:540px; margin-top:50px;"><p style = "font-size:14pt;"><a href = "lokasi_bendung.php">Lihat Data</a></p></div>
		...
		<div style = "position:absolute; margin-left:150px; margin-top:-1550px">
			<?php
				...
				$namaBendung = $_POST['namaBendung'];
				$namaWilayah = $_POST['namaWilayah'];
				$namaJalan = $_POST['namaJalan'];
				$airBendung = $_POST['airBendung'];
				$status = $_POST['status'];
				
				$sql1 = "INSERT INTO lokasi_bendung (nama_bendung, nama_wilayah, nama_jalan, ketinggian_air, status_bendung)
						VALUES ('$namaBendung', '$namaWilayah', '$namaJalan', '$airBendung', '$status')";
