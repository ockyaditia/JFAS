...
<html>
	<head>
		<meta charset = "utf-8">
		<title>Input Data Lokasi Bendung</title>
	...
	<body>
		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div>
					<div id='cssmenu' style = "padding-left:190px; width:750px">
						<ul>
				...
				<div style = "position:absolute; margin-left:50px; margin-top:10px">
					<form method = "post" autocomplete = "on" action = "insert_data_lokasi_bendung.php">
						<p style = "font-size:22pt;">Silahkan input data bendung</p>
						<table class = "fontInput">
							<tr class = "padding">
								<td style = "width:200px;">Nama Bendung <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<input type = "text" name = "namaBendung" placeholder = "Nama Bendung" class = "size" required />
								</td>
							</tr>
							...
							<tr>
								<td>Status Bendung <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<input type = "radio" name = "status" value = "Siaga 1" required> Siaga 1
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "status" value = "Siaga 2" required> Siaga 2
								</td>
							</tr>
							<tr>
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "status" value = "Siaga 3" required> Siaga 3
								</td>
							</tr>
							<tr class = "padding">
								<td> </td>
								<td> </td>
								<td>
									<input type = "radio" name = "status" value = "Normal" required> Normal
								</td>
							</tr>
							
							<tr class = "padding">
								<td>Ketinggian Air (cm) <em style = "color:red">*</em></td>
								<td> : </td>
								<td>
									<input type = "number" name = "airBendung" placeholder = "0" style = "width:80px;" required /> cm
								</td>
							</tr>
