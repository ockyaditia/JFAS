			...
			<div>
				...
				<div>
					<div id='cssmenu' style = "padding-left:270px; width:750px">
						<ul>
						   <li class='last'><a href='rekening_bank.php'><span>Rekening Bank</span></a></li>
						</ul>
					</div>
				</div>
				
				<div style = "position:absolute; margin-left:25px; margin-top:150px; width:700px;">
					<h2 style = "text-align:center;">
						<div style = "position:absolute; margin-left:300px; margin-top:-120px;">
							<img src = "images/warning.png" height = "100px" width = "100px">
						</div>
						Maaf, Nomor Rekening Bank tidak tersedia dikarenakan tidak terjadi bencana banjir
					</h2>
				</div>
