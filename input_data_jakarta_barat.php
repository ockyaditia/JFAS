...
<html>
	<head>
		<meta charset = "utf-8">
		<title>Input Data Jakarta Barat</title>
			...
			<div>
				...
				<div style = "position:absolute; margin-left:50px; margin-top:10px">
					<form method = "post" autocomplete = "on" action = "insert_input_data.php">
						<p style = "font-size:22pt;">Silahkan input data wilayah di <input type = "radio" checked = "checked" name = "jakarta" value = "Jakarta Barat" required> Jakarta Barat</p>
