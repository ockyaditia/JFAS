	...
	<body>
		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:10px; margin-top:20px; width:730px;">
					<h1 style = "text-align:center;">Prakiraan Cuaca JABODETABEK</h1>

					<table cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" width="100%">
					  <tr bgcolor="#CCCCCC">
						<td colspan="2" width="34%" align="center" class="bold">Wilayah</td>
						<td width="33%" align="center" class="bold">Cuaca Hari Ini<br />13 Juni 2014</td>
						<td width="33%" align="center" class="bold">Cuaca Esok Hari<br />14 Juni 2014</td>
					  </tr>
					  
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Kepulauan Seribu</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  <tr>
						<td bgcolor="#e5e7ea">Siang</td>
						<td bgcolor="#e5e7ea">Berawan</td>
						<td bgcolor="#e5e7ea">Berawan</td>
					  </tr>
					  <tr>
						<td bgcolor="#f0f2f5">Malam</td>
						<td bgcolor="#f0f2f5">Hujan Ringan</td>
						<td bgcolor="#f0f2f5">Hujan Ringan</td>
					  </tr>
					  
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Jakarta Utara</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Jakarta Pusat</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr>
						<td bgcolor="#f0f2f5">Malam</td>
						<td bgcolor="#f0f2f5">Berawan</td>
						<td bgcolor="#f0f2f5">Hujan Ringan</td>
					  </tr>
					  
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Jakarta Selatan</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  <tr>
						<td bgcolor="#e5e7ea">Siang</td>
						<td bgcolor="#e5e7ea">Hujan Ringan</td>
						<td bgcolor="#e5e7ea">Hujan Sedang</td>
					  </tr>
					  <tr>
						<td bgcolor="#f0f2f5">Malam</td>
						<td bgcolor="#f0f2f5">Berawan</td>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Jakarta Timur</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Jakarta Barat</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Depok</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Tangerang</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Bekasi</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr onmouseover="this.className='TmlinkHover'" onmouseout="this.className='Tmlink0'">
						<td rowspan="3" bgcolor="#FFFFFF">Bogor</td>
						<td bgcolor="#dadbdd">Pagi</td>
						<td bgcolor="#dadbdd">Berawan</td>
						<td bgcolor="#dadbdd">Berawan</td>
					  </tr>
					  ...
					  <tr>
					   ...
					   <small>Update Terakhir : 13/06/2014 10:55:34</small>
				</div>
				
				<div>
					<div id='cssmenu' style = "padding-left:300px; width:750px">
						<ul>
						   <li class='last'><a href='kondisi_cuaca.php'><span>Data Cuaca</span></a></li>
						</ul>
					</div>
				</div>
