		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:10px; margin-top:20px; overflow:scroll; height:1100px; width:730px;">
					<h2 style = "text-align:center;">Jakarta Barat</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select date, nama_wilayah, nama_jalan, status_wilayah, kondisi_cuaca, ketinggian_air from lokasi_wilayah where id_jakarta = 1";
				...
				<div>
					<div id='cssmenu' style = "padding-left:230px; width:750px">
						<ul>
						   <li class='last'><a href='jakarta_barat.php'><span>Data</span></a></li>
						   <li class='last'><a href='input_data_jakarta_barat.php'><span>Input Data</span></a></li>
						</ul>
					</div>
				</div>
