		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:255px; margin-top:50px;">
					<form method = "get" autocomplete = "on" action = "lokasi_wilayah.php">
						<table>
							<tr>
								<td>
								...
								<td>
									<input style = "width:100px; height:30px; font-size:12pt; font-family: arcena;" type = "submit" value = "Cari"/>
								</td>
							</tr>
						</table>
					</form>
					...
					<?php
						...
						if (!$selected)
							...
							if ($jakarta == "Jakarta Barat") {
								$idJakarta = 1;
								print("<h3 style = 'margin-left:250px;'><span><a href = 'input_data_jakarta_barat.php' style = 'margin-left:50px;'>Silahkan Input Data</a></span></h3>");
								...
								$idJakarta = 2;
								print("<h3 style = 'margin-left:250px;'><span><a href = 'input_data_jakarta_utara.php' style = 'margin-left:50px;'>Silahkan Input Data</a></span></h3>");
								print("<table style = 'font-size:12pt'>");
								print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Status Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Cuaca<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px; width:90px;'>Ketinggian Air<hr style = 'border:2px solid black'></td></tr>");
								print("<hr style = 'border:5px solid black'>");
							}
								...
								$idJakarta = 3;
								print("<h3 style = 'margin-left:250px;'><span><a href = 'input_data_jakarta_pusat.php' style = 'margin-left:50px;'>Silahkan Input Data</a></span></h3>");
								print("<table style = 'font-size:12pt'>");
								print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Status Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Cuaca<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px; width:90px;'>Ketinggian Air<hr style = 'border:2px solid black'></td></tr>");
								print("<hr style = 'border:5px solid black'>");
							}
								...
								$idJakarta = 4;
								print("<h3 style = 'margin-left:250px;'><span><a href = 'input_data_jakarta_selatan.php' style = 'margin-left:50px;'>Silahkan Input Data</a></span></h3>");
								print("<table style = 'font-size:12pt'>");
								print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Status Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Cuaca<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px; width:90px;'>Ketinggian Air<hr style = 'border:2px solid black'></td></tr>");
								print("<hr style = 'border:5px solid black'>");
							}
								...
								$idJakarta = 5;
								print("<h3 style = 'margin-left:250px;'><span><a href = 'input_data_jakarta_timur.php' style = 'margin-left:50px;'>Silahkan Input Data</a></span></h3>");
								print("<table style = 'font-size:12pt'>");
								print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Status Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Cuaca<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px; width:90px;'>Ketinggian Air<hr style = 'border:2px solid black'></td></tr>");
								print("<hr style = 'border:5px solid black'>");
							}
						...
						$sql1 = "select date, nama_wilayah, nama_jalan, status_wilayah, kondisi_cuaca, ketinggian_air from lokasi_wilayah where id_jakarta = '$idJakarta'";
				...
				<div>
					<div id='cssmenu' style = "padding-left:270px; width:750px">
						<ul>
						   <li class='last'><a href='lokasi_wilayah.php'><span>Lokasi Wilayah</span></a></li>
						</ul>
					</div>
				</div>
