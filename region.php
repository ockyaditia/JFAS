	...
	<body>
		...
		<div class = "divKontenFitur">
			...
			<div>
				...
				<h1 style = "margin-left:300px; position:absolute;">DKI JAKARTA</h1>
				
				<div style = "position:absolute; margin-top:80px;">
					<div style = "position:absolute; margin-left:80px;">
						<a href = "jakarta_utara.php"><img src = "images/jakarta_utara-blank.png" width = "650"; height = "220" onmouseover = "this.src='images/jakarta_utara.png'" onmouseout = "this.src='images/jakarta_utara-blank.png'"></a>
					</div>
					<div style = "position:absolute; margin-left:30px; margin-top:25px;">
						<a href = "jakarta_barat.php"><img src = "images/jakarta_barat-blank.png" width = "350"; height = "250" onmouseover = "this.src='images/jakarta_barat.png'" onmouseout = "this.src='images/jakarta_barat-blank.png'"></a>
					</div>
					<div style = "position:absolute; margin-left:283px; margin-top:95px;">
						<a href = "jakarta_pusat.php"><img src = "images/jakarta_pusat-blank.png" width = "220"; height = "180" onmouseover = "this.src='images/jakarta_pusat.png'" onmouseout = "this.src='images/jakarta_pusat-blank.png'"></a>
					</div>
					<div style = "position:absolute; margin-left:378px; margin-top:118px;">
						<a href = "jakarta_timur.php"><img src = "images/jakarta_timur-blank.png" width = "358"; height = "480" onmouseover = "this.src='images/jakarta_timur.png'" onmouseout = "this.src='images/jakarta_timur-blank.png'"></a>
					</div>
					<div style = "position:absolute; margin-left:148px; margin-top:210px;">
						<a href = "jakarta_selatan.php"><img src = "images/jakarta_selatan-blank.png" width = "320"; height = "375" onmouseover = "this.src='images/jakarta_selatan.png'" onmouseout = "this.src='images/jakarta_selatan-blank.png'"></a>
					</div>
				</div>
