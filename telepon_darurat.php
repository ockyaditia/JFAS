			...
			<div>
				...
				<div>
					<div id='cssmenu' style = "padding-left:270px; width:750px">
						<ul>
						   <li class='last'><a href='telepon_darurat.php'><span>Telepon Darurat</span></a></li>
						</ul>
					</div>
				</div>
				
				<div style = "position:absolute; margin-left:10px; margin-top:20px; overflow:scroll; height:1300px; width:730px;">
					<h2 style = "text-align:center;">Nomor Telepon Darurat</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select nama_telepon, no_telepon from telepon_darurat";
						
						$result_sql1 = mysql_query($sql1, $connect);
						
						print("<table bgcolor = '#e5e7ea' style = 'font-size:24pt; font-weight: bolder; margin-left:8px'>");
						print("<tr><td style = 'padding-right:15px;'>Nama Telepon<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nomor Telepon<hr style = 'border:2px solid black'></td></tr>");
						print("<hr style = 'border:5px solid black'>");
						
						while ($row_sql1 = mysql_fetch_row($result_sql1)) {
							print("<tr>");
							foreach($row_sql1 as $key => $value) {
								print("<td style = 'width:340px; height:50px; font-size:18pt;'>$value</td>");
							}
							print("</tr>");
						}
						print("</table>");
