	...
	<body>
		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<h2 style = "text-align:center;">Jakarta Utara</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select date, nama_wilayah, nama_jalan, status_wilayah, kondisi_cuaca, ketinggian_air from lokasi_wilayah where id_jakarta = 2";
