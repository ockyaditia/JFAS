	...
	<body>
		...
		<div class = "divKontenFeedback">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:540px; margin-top:50px;"><p style = "font-size:14pt;"><a href = "feedback.php">Kembali</a></p></div>
		...
		<div style = "position:absolute; margin-top:-600px; margin-left:150px;">
			<?php
				...
				$sql = "INSERT INTO umpan_balik (nama_depan, nama_belakang, email, tanggapan)
						VALUES ('$firstname', '$lastname', '$email', '$tanggapan')";
