		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:10px; margin-top:20px; overflow:scroll; height:1100px; width:730px;">
					<h2 style = "text-align:center;">Lalu Lintas</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select date, nama_wilayah, nama_jalan, informasi_lalulintas, kondisi_jalan from lalu_lintas";
						
						$result_sql1 = mysql_query($sql1, $connect);
						
						print("<table style = 'font-size:14pt'>");
						print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Lalu Lintas<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Kondisi Jalan<hr style = 'border:2px solid black'></td></tr>");
