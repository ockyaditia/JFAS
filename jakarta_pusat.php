	...
	<body>
		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<h2 style = "text-align:center;">Jakarta Pusat</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select date, nama_wilayah, nama_jalan, status_wilayah, kondisi_cuaca, ketinggian_air from lokasi_wilayah where id_jakarta = 3";
				...
				<div>
					<div id='cssmenu' style = "padding-left:230px; width:750px">
						<ul>
						   <li class='last'><a href='jakarta_pusat.php'><span>Data</span></a></li>
						   <li class='last'><a href='input_data_jakarta_pusat.php'><span>Input Data</span></a></li>
						</ul>
					</div>
				</div>
