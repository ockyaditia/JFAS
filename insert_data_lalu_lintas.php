	...
	<body>
		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:540px; margin-top:50px;"><p style = "font-size:14pt;"><a href = "lalu_lintas.php">Lihat Data</a></p></div>
		...
		<div style = "position:absolute; margin-left:150px; margin-top:-2780px">
			<?php
				...
				$lalulintas = $_POST['lalulintas'];
				$jalan = $_POST['jalan'];
				
				$sql1 = "INSERT INTO lalu_lintas (id_jakarta, nama_wilayah, nama_jalan, informasi_lalulintas, kondisi_jalan)
						VALUES ('$idJakarta', '$namaWilayah', '$namaJalan', '$lalulintas', '$jalan')";
