		...
		<div class = "divKontenJakarta">
			...
			<div>
				...
				<div style = "position:absolute; margin-left:10px; margin-top:20px; overflow:scroll; height:1100px; width:730px;">
					<h2 style = "text-align:center;">Informasi Bendung</h2>
					<br>
					...
					<?php
						...
						$sql1 = "select date, nama_bendung, nama_wilayah, nama_jalan, ketinggian_air, status_bendung from lokasi_bendung";
						
						$result_sql1 = mysql_query($sql1, $connect);
						
						print("<table style = 'font-size:14pt'>");
						print("<tr style = 'text-align:center;'><td style = 'padding-right:15px;'>Tanggal<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Bendung<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Wilayah<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Nama Jalan<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Ketinggian Air<hr style = 'border:2px solid black'></td><td style = 'padding-right:15px;'>Status Bendung<hr style = 'border:2px solid black'></td></tr>");
						print("<hr style = 'border:5px solid black'>");
						
						while ($row_sql1 = mysql_fetch_row($result_sql1)) {
							print("<tr>");
							foreach($row_sql1 as $key => $value) {
								print("<td style = 'width:140px; height:50px; font-size:12pt; text-align:center;'>$value</td>");
							}
							print("</tr>");
						}
						print("</table>");
				...
				<div>
					<div id='cssmenu' style = "padding-left:230px; width:750px">
						<ul>
						   <li class='last'><a href='lokasi_bendung.php'><span>Lokasi Bendung</span></a></li>
						   <li class='last'><a href='input_data_lokasi_bendung.php'><span>Input Data</span></a></li>
						</ul>
					</div>
				</div>
